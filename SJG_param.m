...
PARAM.NRTL.AMPL  = 0.04058; % RTL compressor ampl (MV)
...
PARAM.LI10.ELO   = -0.04;  % low energy cut
PARAM.LI10.EHI   = 0.04;   % high energy cut
...
PARAM.LI20.ELO   = -0.04;   % RTL lower momentum cut (GeV)
PARAM.LI20.EHI   = 0.04;    % RTL upper momentum cut (GeV)

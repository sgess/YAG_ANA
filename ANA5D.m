...
for k = 1:6 % ramp
    ...
    for l = 1:6 % compressor phase
        ...
        bl_line1 = [bl_line1 RES.CON.SQ(:,:,k,l,1,1)];
        bl_line2 = [bl_line2 RES.CON.SQ(:,:,k,l,2,1)];
        bl_line3 = [bl_line3 RES.CON.SQ(:,:,k,l,3,1)];
        bl_line4 = [bl_line4 RES.CON.SQ(:,:,k,l,4,1)];
        bl_line5 = [bl_line5 RES.CON.SQ(:,:,k,l,5,1)];
        bl_line6 = [bl_line6 RES.CON.SQ(:,:,k,l,6,1)];
